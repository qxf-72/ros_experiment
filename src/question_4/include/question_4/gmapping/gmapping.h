...
#ifndef QUESTION4_GMAPPING_GMAPPING_H_
#define QUESTION4_GMAPPING_GMAPPING_H_
...
#include "question_4/gmapping/grid/map.h"
#include "question_4/gmapping/grid/gridlinetraversal.h"
